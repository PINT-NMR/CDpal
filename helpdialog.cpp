...
void helpDialog::changeTopic()
{
    ...
    else if(ui->topicList->currentRow()==4) //Fit data
    {
        ...
        html ="<b>Fitting data</b><hr><br>"
                ...
                "Differentiate is a new feature in CDpal, useful for extracting &Delta;H and T<sub>m</sub> of thermal denaturation data sets that are difficult to fit using the standard models.<br>"
